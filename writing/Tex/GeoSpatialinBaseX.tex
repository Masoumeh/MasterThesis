...
\centering
\subfigure{
	\includegraphics[width=0.45\textwidth]{BXvsMongo-Insertion.png}
	\label{figBXvsMongoInsert}
}
\centering
\subfigure{
	\includegraphics[width=0.45\textwidth]{BXvsMongo-Deletion.png}
