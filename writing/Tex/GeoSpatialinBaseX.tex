...
Here, we discuss our reasons for this selection.
In general, trees based on B-tree are designed to efficiently search structures stored in disk files.
Among those, R-tree is a common technique which is widely used in spatial databases.
Focusing the static R-tree
