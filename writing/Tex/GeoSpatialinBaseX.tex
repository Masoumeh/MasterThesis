...
%\begin{itemize}
%\item The column-store aproach of MonetDB is advantagous for geospatial data, since skips the unnecessary %attributes. This becomes important as only a fraction of data is needed in most of 
%\end{itemize}
...
%These points would be either the final diestination as the final output or a middle point to proceed the algorithm to find new connected points. This process is continued to find the destination and the path would be joined edges which are detected in easch step  
