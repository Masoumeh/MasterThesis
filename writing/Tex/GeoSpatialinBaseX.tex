...
\textbf{$R^*$-tree}
In order to achieve better performance, $R^*$-tree~\cite{rstartree} goes beyond the MBR area minimization with trying following criteria, as Manolopoulos et al~\cite{Manolopoulos:2005} explains,
\begin{itemize}
