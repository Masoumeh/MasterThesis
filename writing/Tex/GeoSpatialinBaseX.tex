...
In general, B-tree based structures are designed to search efficiently structures stored in disk files.
Among those, the R-tree are a common technique which is widely used in spatial databases according to Lee et al~\cite{Lee}. 
...
Papadopoulos~\cite{Papadopoulos2010} states that STR-tree generally outperforms
