...
In addition to the abovementioned limitations, importing a \textit{JSON} file into MongoDB should contain individual Features or geometries and not be in the form of a FeatureCollection as bellow, 
...
Since a \textit{FeatureCollection} contains the whole objects inside and is considered as one object it might be bigger than 16MB. This structure for the above file will be as following,
\begin{verbatim}
{
 "type": "FeatureCollection",
 "crs": 
