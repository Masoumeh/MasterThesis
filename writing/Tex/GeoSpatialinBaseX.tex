...
The previous versions of GML, namely before the version 3.0, encode a set of 2D geometries, i.e. Point, LineString, and Polygon. The GML 3.0 introduces Curve and Surface as new geometries, plus the support of geometries in 3D.
