...
The contribution of the current work is to see how the geospatial data process could be challenging in \textit{BaseX}. 
...
Finally, the geospatial functionalities are added to BaseX based on GML2 standard.
...
As an experimental way to provide more efficient geospatial features, we make a connection to MongoDB, a powerful document-based database, 
