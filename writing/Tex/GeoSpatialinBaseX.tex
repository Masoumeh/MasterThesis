...
\subsection{Summary}
Regarding the discussion in this section, there is no optimum indexing structure for any type of data and requirement. Based on the application, each structure has pros and cons. The catogories that we presented and Among the for   
\newpage
%\Rotatebox{-90}
\begin{turn}{270}
...
R-tree & B-tree & Highly balanced point and non-point objects indexing & Large covered area and overlappings by MBRs, Multiple path traversal in point queries\\\hline
$R^+$-tree & R-tree & No overlappings of MBRs, No multiple path traversal & Rectangle duplication, Bigger and complicated structure, Complex deletion process, Dead spaces\\\hline
Cell-tree & R-tree & No overlappings and dead spaces & Object duplication\\\hline
$R^*$-tree & R-tree & Minimizing the coverage area, overlappings, and margin of MBRs, Minimizing the storage utilization & Silghtly more cost\\\hline
Packed R-Tree & R-tree & Storage and performance efficiency & Poor performance in frequent modification of data\\\hline
STR-tree & R-tree & Storage and performance efficiency & Poor performance in frequent modification of data\\\hline
X-tree & R-tree & No overlappings of MBRs & Good performance\\\hline
Quad-tree & Space filing structures & & Poor performance in high-dimensional data\\\hline
\end{tabular}
%}
