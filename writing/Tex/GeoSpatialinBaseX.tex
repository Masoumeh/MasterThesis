...
Also, R-trees are a common technique which is widely used in spatial databases.
...
Besides!!!, the STR-tree as a static variant of the R-tree is counted as an advanced one 
...
In contrast to STR-tree, it is particularly optimized when the data set is changed dynamically.
