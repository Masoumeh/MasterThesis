...
Based on our investigations, the earliest topics of geospatial processing in databases are discussing three main areas: storage, querying, and indexing. There are a large amount of researches and literature in these topics which we summarize the selected ones here. Besides, the geospatial processing issues in three famous databases are reviewed which might be beneficial to design the properly fitting solutions in BaseX. %TODO: three famous databases -> or four when monetdb is written.
