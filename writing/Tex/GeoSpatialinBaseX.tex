...
The packed R-tree could be created with other packing algorithms. 
The Hilbert Packed R-tree is another method to construct a static R-tree using Hilbert Sort~\cite{hilbert-rtree} packing algorithm proposed by Kamel and Faloutsos. This method with $100\%$ space utilization, proposes sorting the objects based on their Hilbert value of their center and then inserting them into the tree.
T
In the following, another packing algorithm is described which we will use to create a static index structure.
