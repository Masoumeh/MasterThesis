...
Here, we summerize just a short list of them based on different approaches. 
Section~\ref{xquery-based} starts the discussion with the XQuery based languages which extend XQuery
to process the GML data.
Then, we bring related work regarding the integration of the geospatial and non-geospatial
